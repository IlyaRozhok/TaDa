...
export class MoveOccupationToPreferences1767461425272 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "tenant_cvs" DROP CONSTRAINT "FK_tenant_cvs_user"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."idx_properties_bathrooms"`);
        await queryRunner.query(`DROP INDEX "public"."idx_properties_property_type"`);
        await queryRunner.query(`DROP INDEX "public"."idx_properties_furnishing"`);
        await queryRunner.query(`DROP INDEX "public"."idx_properties_tenant_types"`);
        await queryRunner.query(`DROP INDEX "public"."idx_properties_amenities"`);
        await queryRunner.query(`DROP INDEX "public"."idx_properties_available_from"`);
        await queryRunner.query(`DROP INDEX "public"."idx_properties_operator_id"`);
        await queryRunner.query(`DROP INDEX "public"."idx_properties_building_id"`);
        await queryRunner.query(`ALTER TABLE "booking_requests" DROP CONSTRAINT "UQ_booking_requests_property_tenant"`);
        await queryRunner.query(`ALTER TABLE "preferences" ADD "occupation" character varying`);
        ...
        await queryRunner.query(`ALTER TABLE "booking_requests" ADD CONSTRAINT "UQ_9ba3da4fd4396cb4555855222ca" UNIQUE ("property_id", "tenant_id")`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "tenant_cvs" DROP CONSTRAINT "FK_1cf1047690c039fa3d5239b6755"`);
        ...
        await queryRunner.query(`ALTER TABLE "preferences" DROP COLUMN "occupation"`);
        ...
        await queryRunner.query(`CREATE INDEX "idx_properties_building_id" ON "properties" ("building_id") `);
        await queryRunner.query(`CREATE INDEX "idx_properties_operator_id" ON "properties" ("operator_id") `);
        await queryRunner.query(`CREATE INDEX "idx_properties_available_from" ON "properties" ("available_from") `);
        await queryRunner.query(`CREATE INDEX "idx_properties_amenities" ON "properties" ("amenities") `);
        await queryRunner.query(`CREATE INDEX "idx_properties_tenant_types" ON "properties" ("tenant_types") `);
        await queryRunner.query(`CREATE INDEX "idx_properties_furnishing" ON "properties" ("furnishing") `);
        await queryRunner.query(`CREATE INDEX "idx_properties_property_type" ON "properties" ("property_type") `);
        await queryRunner.query(`CREATE INDEX "idx_properties_bathrooms" ON "properties" ("bathrooms") `);
