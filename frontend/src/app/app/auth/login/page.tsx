          ...
          >
            ...
            <div className="relative mb-6">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-3 py-1 rounded-lg text-white bg-white/10 backdrop-blur-sm">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full text-white bg-white/60 backdrop-blur-sm px-4 py-2.5 rounded-lg border border-slate-400/60 focus:border-slate-600/70 focus:ring focus:ring-slate-500/40 focus:ring-opacity-50 transition-colors duration-200 placeholder:text-slate-600"
