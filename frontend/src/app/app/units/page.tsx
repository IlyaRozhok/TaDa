...
function TenantDashboardContent() {
  ...
  // A failed FIRST load gets an honest error screen with a retry. It used to
  // fall through to the empty grid, which told the tenant "no results found"
  // — a plausible lie on a rental site — whenever the API blipped. A refetch
  // failure while stale data is on screen keeps showing the data instead.
  if (feedError && !feedData && !feedFetching) {
    return (
      <div className="min-h-screen bg-white flex flex-col">
        <div className="flex-1 flex items-center justify-center">
          <div className="text-center max-w-md">
