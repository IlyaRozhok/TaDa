...
export const InputField: React.FC<InputFieldProps> = ({
  ...
  const inputProps = {
    ...
    className:
      "w-full px-6 pt-8 pb-4 rounded-4xl focus:outline-none transition-all duration-200 text-gray-900 bg-gray-50 sm:bg-white placeholder-transparent border-0 shadow-sm",
    placeholder: "",
    required,
  };
    ...
    <div className={`relative ${className}`}>
      {shouldUseMask ? (
        <IMaskInput
          ...
          className="w-full px-6 pt-8 pb-4 rounded-4xl focus:outline-none transition-all duration-200 text-gray-900 bg-gray-50 sm:bg-white placeholder-transparent border-0 shadow-sm"
          placeholder=""
        />
      ) : (
        <input {...inputProps} />
