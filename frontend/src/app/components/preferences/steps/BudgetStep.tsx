...
export const BudgetStep: React.FC<BudgetStepProps> = ({
  ...
  const setThumbPosition = useCallback((thumbType: 'min' | 'max', percentage: number) => {
  ...
  }, [formData.min_square_meters, formData.max_square_meters, valueToPercentage, setThumbPosition]);
  ...
  const handleMinInputBlur = useCallback((e: React.FocusEvent<HTMLInputElement>) => {
  ...
  const handleMaxInputBlur = useCallback((e: React.FocusEvent<HTMLInputElement>) => {
  ...
  const handleMinRangeChange = useCallback((e: React.ChangeEvent<HTMLInputElement>) => {
  ...
  const handleMaxRangeChange = useCallback((e: React.ChangeEvent<HTMLInputElement>) => {
          ...
          <div className="px-2">
            ...
            <div 
              ...
              style={{
                ...
                '--min-thumb-percent': valueToPercentage(formData.min_square_meters ?? 15),
                '--max-thumb-percent': valueToPercentage(formData.max_square_meters ?? 45),
