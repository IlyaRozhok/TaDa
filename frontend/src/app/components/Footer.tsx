      ...
      <div className="container mx-auto px-4">
        ...
        <div className="border-t border-gray-800 pt-8">
          ...
          <div className="hidden lg:grid lg:grid-cols-[minmax(0,1fr)_auto_minmax(0,1fr)] lg:items-center lg:gap-6">
            <p className="text-gray-400 text-sm justify-self-start text-left">
              {t(generalKeys.footer.allRightsReserved)}
            </p>
            <nav
              className="text-gray-400 text-sm flex flex-wrap items-center justify-center gap-x-2 gap-y-1"
              aria-label="Legal"
            >
              <a
                href="/privacy"
            ...
            <p className="text-gray-400 text-sm justify-self-end text-right">
          ...
          <div className="flex flex-col items-center gap-4 lg:hidden">
            ...
            <nav
              className="text-gray-500 text-xs flex flex-wrap items-center justify-center gap-x-2 text-center"
              aria-label="Legal"
            >
