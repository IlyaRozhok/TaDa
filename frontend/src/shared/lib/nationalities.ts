// Nationality options for profile forms
// Based on common nationalities with proper labels
...
/**
 * Get nationality option by value
 */
export function getNationalityByValue(value: string): NationalityOption | undefined {
  return NATIONALITY_OPTIONS.find((n) => n.value === value);
}

/**
 * Get nationality options sorted alphabetically
 */
