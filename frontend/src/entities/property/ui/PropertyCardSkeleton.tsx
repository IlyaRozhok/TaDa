...
export default function PropertyCardSkeleton() {
  return (
    <div className="w-full min-w-0 bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden animate-pulse">
      ...
      <div className="relative aspect-[16/10] min-h-[9rem] bg-gradient-to-br from-slate-200 via-slate-100 to-slate-200 bg-[length:200%_200%] animate-[shimmer_2s_infinite]">
