...
**Текущий шаг: 1.3** — 🟡 базовая сетка поднята (11 тестов зелёные локально), ветка `test/e2e-safety-net`.
Следующий под-шаг 1.3b — укрепление селекторов через `data-testid`.
