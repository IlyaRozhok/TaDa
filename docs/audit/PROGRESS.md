...
**Текущий шаг: 2.1** — 🟡 удаление `src/components/`, ветка `refactor/remove-orphan-components`, PR открыт.
...
**Дальше по Фазе 2:** 2.2 → 2.3 → 2.5 → 2.6, затем Фаза 2А (снос operator-UI).
