...
**Правило действует вперёд.** Уже написанные по-русски документы и комментарии
массово не переводим — это отдельная задача, если владелец её поставит.
Но: правишь файл — приводи затронутые строки к английскому, по тому же принципу,
что и с импортами (см. «Где граница уборки»).
